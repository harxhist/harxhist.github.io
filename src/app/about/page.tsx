    ...
    <Column maxWidth="m">
      ...
      <Row fillWidth s={{ direction: "column"}} horizontal="center">
        ...
        <Column className={styles.blockAlign} flex={9} maxWidth={40}>
          ...
          {about.work.display && (
            <>
              <Heading as="h2" onBackground="brand-weak" id={about.work.title} variant="display-strong-s" marginBottom="s">
                {about.work.title}
              </Heading>
          ...
          {about.studies.display && (
            <>
              <Heading as="h2" onBackground="brand-weak" id={about.studies.title} variant="display-strong-s" marginBottom="m">
                {about.studies.title}
              </Heading>
